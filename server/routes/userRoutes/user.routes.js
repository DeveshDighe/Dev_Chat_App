const { getUser, createUser, loginUser, logOut, searchUsers, sendRequest, acceptRequest, getAllRequests, getMyFriends, getUserProfileDetail, getAllUser } = require('../../controllers/user.controller');
